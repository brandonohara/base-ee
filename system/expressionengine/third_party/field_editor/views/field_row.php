			<tr class="<?=alternator('even', 'odd')?>" id="row_<?=$field['rowid']?>" data-rowid="<?=$field['rowid']?>" data-id="<?=$field['field_id']?>">
				<td class="drag_handle">
					<img border="0" src="<?=URL_THIRD_THEMES?>field_editor/images/drag_handle.gif" width="10" height="17">
					<?=form_hidden('fields['.$index.'][field_type_settings]', $field['field_type_settings'])?>
					<?=form_hidden('fields['.$index.'][rowid]', $field['rowid'])?>
					<?=form_hidden('fields['.$index.'][field_id]', $field['field_id'])?>
				</td>
				<td>
					<a href="<?=BASE.AMP.'C=admin_content'.AMP.'M=field_edit'.AMP.'field_id='.$field['field_id'].AMP.'group_id='.$field['group_id']?>" target="_blank">
						<?=$field['field_id']?>
					</a>
				</td>
				<td>
				...
				<td>
					<a href="javascript:void(0);" title="<?=lang('field_editor_more_settings')?>" class="settings">
						<img border="0" src="<?=URL_THIRD_THEMES?>field_editor/images/fe_icon_settings.png" alt="<?=lang('field_editor_more_settings')?>">
					</a>
				</td>
				<td>
					<a href="javascript:void(0);" title="<?=lang('field_editor_add_field')?>" class="add_field">
						<img border="0" src="<?=URL_THIRD_THEMES?>field_editor/images/fe_icon_plus.png" alt="<?=lang('field_editor_add_field')?>">
					</a>
				</td>
				<td>
					<a href="javascript:void(0);" title="<?=lang('field_editor_delete_field')?>" class="delete_field">
						<img border="0" src="<?=URL_THIRD_THEMES?>field_editor/images/fe_icon_minus.png" alt="<?=lang('field_editor_delete_field')?>">
					</a>
				</td>
			</tr>